...
eval(fs.readFileSync('./scripts/application/utility.js')+'');
eval(fs.readFileSync('./scripts/gamestate/building.js')+'');
eval(fs.readFileSync('./scripts/gamestate/unit.js')+'');
eval(fs.readFileSync('./scripts/gamestate/ray.js')+'');
eval(fs.readFileSync('./scripts/gamestate/player.js')+'');
eval(fs.readFileSync('./scripts/gamestate/gameobject.js')+'');
